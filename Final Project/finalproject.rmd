...
```{r, fig.width=100, fig.height=80 }

par(mfrow = c(2, 2))
par(cex.main = 10, cex.lab = 10, cex.axis = 10)


plot(log_ts41_avg, main = "Graph 8: 12 hour moving average pm25 levels at station 41, 2020", xlab = "Time", ylab= "Pm25 level (log of)")

plot(log_ts55_avg, main = "Graph 9: 12 hour moving average pm25 levels at station 55, 2020", xlab = "Time", ylab= "Pm25 level (log of)")

plot(log_ts92_avg, main = "Graph 10: 12 hour moving average pm25 levels at station 92, 2020", xlab = "Time", ylab= "Pm25 level (log of)")

plot(log_ts97_avg, main = "Graph 11: 12 hour moving average pm25 levels at station 97, 2020", xlab = "Time", ylab= "Pm25 level (log of)")
```
