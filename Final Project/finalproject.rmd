...
plot(log_ts41_avg, main = "Graph 8: pm25 levels at station 41", xlab = "Time", ylab= "Pm25 level (log of)")

plot(log_ts55_avg, main = "Graph 9: pm25 levels at station 55", xlab = "Time", ylab= "Pm25 level (log of)")

plot(log_ts92_avg, main = "Graph 10: pm25 levels at station 92", xlab = "Time", ylab= "Pm25 level (log of)")

plot(log_ts97_avg, main = "Graph 11: pm25 levels at station 97", xlab = "Time", ylab= "Pm25 level (log of)")
```
