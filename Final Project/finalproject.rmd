...
#     main = "Graph 11: Station 41 - Observed and Model Forecasts",
#     type = "l"
#)
#lines()
...
Clearly, the values for State 2 Expected Value and one-step-ahead prediction are the same, as it seems that for all stations, the value of PM2.5 is expected to be high, hence being in state 2. 
