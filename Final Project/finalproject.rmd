...
ma_t_plot <- plot(daily_avg_ma_t, main = "Graph 2: Average Daily Temperature (C°) at station 55, 2020",cex.main=0.9, xlab = "Time", ylab= "Average Daily Temperature (C°)")
```
...
ma_w_plot <- plot(daily_avg_ma_w, main = "Graph 3: Average Wind Speed (knots/second) at station 55, 2020", cex.main=0.9, xlab = "Time", ylab= "Average Wind Speed (knots/second)")
...
Table 2 shows us the estimations of the mean and the standard deviation of the distribution of the states. 

Table 3 gives the expected number of hours for pollution state to move from i to j (where i and j are different).
...
plot(as.POSIXct(st55datset$datetime), estStates[,1],ylab= "Predicted State", xlab="Time" ,  cex=.3, type="s", main="Graph 7: State predictions", cex.main=0.9) 
```
...
#plot(x = as.Date(attr(outFilt$f,"index")[6:n]),
#     y = outFilt$f[6:n,1],
#     xlab = "Date", ylab = "PM2.5 level (log of)",
#     main = "Graph 11: Station 41 - Obeserved and Model Forecasts",
#     type = "l"
#)
#lines()
