...
autoplot(HWgas)+
  ggtitle("Figure 6: H&W Gas Consumption")
```
...
sing Holt-Winters exponential smoothing we get the following plot. The value of $\alpha$ chosen (by default) is 0.2465579
