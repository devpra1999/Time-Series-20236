...
plot(daily_avg_ma_t, main = "Graph 2: Average Daily Temperature (C°) at station 55, June-September 2020", xlab = "Time", ylab= "Average Daily Temperature (C°)")
```
...
plot(daily_avg_ma_w, main = "Graph 3: Average Wind Speed (knots/second) at station 55, June-September 2020", xlab = "Time", ylab= "Average Wind Speed (knots/second)")
```
...
p <- ggplot(data=st55datset, aes(x=Time, y=pm25)) +
  ...
  geom_line() +
  annotate(geom="text", x=as.POSIXct("2020-06-20"), y=200, label="Dangerous PM2.5 level", color="darkred") +
