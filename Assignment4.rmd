...
plot(daily_avg_ma_pm25,main = "Graph 1: Average PM25 levels at station 55, June-September 2020", xlab = "Time", ylab= "Average PM25 level per day")
...
plot(daily_avg_ma_t, main = "Graph 2: Average temperature levels at station 55, June-September 2020", xlab = "Time", ylab= "Average temperature level per day")
```
...
plot(daily_avg_ma_w,main = "Graph 3: Average wind levels at station 55, June-September 2020", xlab = "Time", ylab= "Average wind level per day")
```
...
```{r compare}
plot(scale(daily_avg_ma_pm25), col = "darkgreen", main = "Graph 4: Scaled development of PM25, temperature and wind, June-September 2020", cex.main=0.9,xlab = "Time", ylab= "Average Temperature level per day")
